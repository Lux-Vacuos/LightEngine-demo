...
public class OptionsWindow extends ComponentWindow {
	...
	private void mainMenu() {
		...
		Button wm = new Button(40, -100, 200, 40, LANG.getRegistryItem("lightengine.optionswindow.btnwm"));
	...
	private void graphicOptions() {
		...
		Text shadowsText = new Text(LANG.getRegistryItem("lightengine.optionswindow.graphics.shadows"), 20, 0);
		shadowsText.setWindowAlignment(Alignment.LEFT);
		Text dofText = new Text(LANG.getRegistryItem("lightengine.optionswindow.graphics.dof"), 20, 0);
		dofText.setWindowAlignment(Alignment.LEFT);
		Text fxaaText = new Text(LANG.getRegistryItem("lightengine.optionswindow.graphics.fxaa"), 20, 0);
		fxaaText.setWindowAlignment(Alignment.LEFT);
		Text motionBlurText = new Text(LANG.getRegistryItem("lightengine.optionswindow.graphics.motionblur"), 20, 0);
		motionBlurText.setWindowAlignment(Alignment.LEFT);
		Text reflectionsText = new Text(LANG.getRegistryItem("lightengine.optionswindow.graphics.reflections"), 20, 0);
		reflectionsText.setWindowAlignment(Alignment.LEFT);
		Text parallaxText = new Text(LANG.getRegistryItem("lightengine.optionswindow.graphics.parallax"), 20, 0);
	...
	public void processWindowMessage(int message, Object param) {
		if (message == WindowMessage.WM_CLOSE) {
			...
			EventSubsystem.triggerEvent("lightengine.renderer.savesettings");
